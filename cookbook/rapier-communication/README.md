# Rapier Communication Example

This example demonstrates the [Communication](https://ranganaths.github.io/Rapier/communication.html) concept in Rapier, specifically focusing on the Shared Store pattern.
